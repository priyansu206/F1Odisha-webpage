...
const setColor = (uniform: { value: number[] }, hex: string) => {
...
const contexts = new WeakMap<HTMLElement, {
  renderer: Renderer;
  program: Program;
  mesh: Mesh;
  render: () => void;
...
const GhostFibers = ({
  ...
  useEffect(() => {
    ...
    setColor(uniforms.uLineColor as never, lineColor);
    setColor(uniforms.uGlowColor as never, glowColor);
